...
class StockFetcher:
    ...
    TICKERS = {
        ...
        "조선": {"yahoo": "102960.KS", "name": "KODEX 조선"},

        # 소비/서비스 섹터 ETF
        # KODEX 필수소비재(266410)·경기소비재(266390)는 2017-03 상장이라
        # 뉴스 시작(2016-03)을 못 덮는다. 시계열이 긴 TIGER 시리즈를 쓴다.
        "필수소비재": {"yahoo": "227560.KS", "name": "TIGER 200 생활소비재"},
        "경기소비재": {"yahoo": "139290.KS", "name": "TIGER 경기소비재"},
        "여행레저": {"yahoo": "228800.KS", "name": "TIGER 여행레저"},
